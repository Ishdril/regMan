...
describe('Form', () => {
  ...
  test('user can clear the form', () => {
    ...
    // expect(name).toHaveValue('Pepe');
    // fireEvent.click(clearForm);    // throwing error ->  Invariant failed: You should not use <Redirect> outside a <Router>
  ...
  test('user can send send his registration', () => {
    ...
    // TODO: assign value to inputs and then check if its value is ''
    // fireEvent.click(submit);    // throwing error ->  Invariant failed: You should not use <Redirect> outside a <Router>
